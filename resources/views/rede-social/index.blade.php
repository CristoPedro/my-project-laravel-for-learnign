                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2 active"
                                    aria-current="page" href="{{ route('home-site') }}"> <svg class="bi"
                                        aria-hidden="true">
                            ...
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2"
                                    href="{{ route('redes-sociais.index') }}"> <svg class="bi"
                                        aria-hidden="true">
                            ...
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2"
                                    href="{{ route('redes-sociais.create') }}"> <svg class="bi"
                                        aria-hidden="true">
                                        <use xlink:href="#cart"></use>
                                    </svg>
                                    Novo
                    ...
                    <table class="table table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-end" scope="col">Definições</th>
